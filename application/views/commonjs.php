...
<script src="<?php echo base_url()?>assets/vendors/bower_components/autosize/dist/autosize.min.js"></script>
...
<script src="<?php echo base_url()?>assets/js/jquery.wheelmenu.js" type="text/javascript"></script>
